<?php ?>
					...
					<?php if (AuthComponent::user('id')): ?>
						<li class="no-print"><?php echo $this->Html->link(__('User Help'),  array('controller' => 'users', 'action' => 'help', 'admin' => false, 'manager' => false, 'saa' => false, 'plugin' => false), array('class' => 'highlighted fa fa-question-circle fa-icon-only fa-fw fa-lg')); ?></li>
